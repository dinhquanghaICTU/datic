# 1 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c"
...
# 2 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c" 2
...
# 3 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c" 2
...
# 4 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c" 2
...
# 7 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c" 2
...
# 8 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c" 2
...
# 11 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c" 2
# 20 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c"
int backtrace_now(int (*print_func)(const char *fmt, ...), uintptr_t *regs) __attribute__ ((weak, alias ("backtrace_riscv")));
# 65 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c"
...
static inline void backtrace_stack_app(int (*print_func)(const char *fmt, ...), unsigned long *fp, int depth) {
  ...
  while (depth--) {
    if ((((uintptr_t)fp & 0xff000000ul) != (0x03000000)) && (((uintptr_t)fp & 0xff000000ul) != (0x02000000))) {
      print_func("!!\r\n");
      return;
    }
    ...
    if ((((uintptr_t)pc & 0xff000000ul) != (0x03000000)) && (((uintptr_t)pc & 0xff000000ul) != (0x02000000))) {
      print_func("!!\r\n");
      return;
    }

    if ((unsigned long)pc > (0x02000000)) {




      fp = (unsigned long *)pc;
    } else if ((uintptr_t)pc > (0x03000000)) {
      print_func("backtrace: %p\r\n", pc);
...
# 219 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic_c.c"
...
static void backtrace_task(int (*print_func)(const char *s), char ptAddr[][12], uintptr_t *fp, int depth)
{
 ...
 while (depth && (((uintptr_t) cur_fp & 0xf000000ul) == (0x02000000))) {
  ra = (uintptr_t*) cur_fp[-1];
  if ((((uintptr_t) ra & 0x0f000000ul) != (0x03000000))
   && (((uintptr_t) ra & 0x0f000000ul) != (0x02000000))
   && (((uintptr_t) ra & 0x0f000000ul) != (0x01000000))) {
   break;
  }
...
int backtrace_now_task(int (*print_func)(const char *s), uintptr_t *regs)
{
 ...
 {
  { List_t * const pxConstList = ( pxAllList ); ( pxConstList )->pxIndex = ( pxConstList )->pxIndex->pxNext; if( ( void * ) ( pxConstList )->pxIndex == ( void * ) &( ( pxConstList )->xListEnd ) ) { ( pxConstList )->pxIndex = ( pxConstList )->pxIndex->pxNext; } ( pxFirstTCB ) = ( pxConstList )->pxIndex->pvOwner; };
  do
  {
   { List_t * const pxConstList = ( pxAllList ); ( pxConstList )->pxIndex = ( pxConstList )->pxIndex->pxNext; if( ( void * ) ( pxConstList )->pxIndex == ( void * ) &( ( pxConstList )->xListEnd ) ) { ( pxConstList )->pxIndex = ( pxConstList )->pxIndex->pxNext; } ( pxNextTCB ) = ( pxConstList )->pxIndex->pvOwner; };
   ...
   fp = (uintptr_t*) (pxTopOfStack + 34 + 5);
   fp = (uintptr_t*) *fp;
   ...
   reg = (uintptr_t*) pxTopOfStack + 34 + 1;
   reg = (uintptr_t*) *reg;
   snprintf(ptAddr[pt_num], sizeof(ptAddr[0]), "%p", reg);
   print_func("    ");
   print_func(ptAddr[pt_num++]);
