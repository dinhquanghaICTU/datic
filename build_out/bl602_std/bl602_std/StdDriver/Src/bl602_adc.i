# 1 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
# 1 "/home/dinhquangha/Ai-Thinker-WB2/datic/build_out/bl602_std//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
# 37 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
...
# 38 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" 2
...
# 39 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" 2
# 67 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
static intCallback_Type * adcIntCbfArra[ADC_INT_ALL]={
# 67 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" 3 4
                                                     ((void *)0)
# 67 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
                                                         };
...
# 106 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Reset(void)
{
    uint32_t regCmd;
...
# 125 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Enable(void)
{
    uint32_t tmpVal;
...
# 142 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Disable(void)
{
    uint32_t tmpVal;
...
# 160 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Init(ADC_CFG_Type* cfg)
{
    uint32_t regCfg1;
    uint32_t regCfg2;
...
# 242 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Channel_Config(ADC_Chan_Type posCh,ADC_Chan_Type negCh,BL_Fun_Type contEn)
{
    uint32_t regCmd;
    uint32_t regCfg1;
...
# 275 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Scan_Channel_Config(ADC_Chan_Type posChList[],ADC_Chan_Type negChList[],uint8_t scanLength,BL_Fun_Type contEn)
{
    uint32_t tmpVal,i;
    uint32_t dealLen;
...
# 336 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Start(void)
{
    uint32_t regCmd;
...
# 362 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Stop(void)
{
    uint32_t regCmd;
...
# 380 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_FIFO_Cfg(ADC_FIFO_Cfg_Type *fifoCfg)
{
    uint32_t tmpVal;
...
# 415 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
uint8_t ADC_Get_FIFO_Count(void)
{
    uint32_t tmpVal;
...
# 432 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Sts_Type ADC_FIFO_Is_Full(void)
{
    uint32_t tmpVal;
...
# 453 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Sts_Type ADC_FIFO_Is_Empty(void)
{
    uint32_t tmpVal;
...
# 477 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
uint32_t ADC_Read_FIFO(void)
{
    uint32_t tmpVal;
...
# 496 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Parse_Result(uint32_t *orgVal,uint32_t len,ADC_Result_Type *result)
{
    uint8_t neg=0;
...
# 571 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_IntMask(ADC_INT_Type intType, BL_Mask_Type intMask)
{
    uint32_t tmpVal;
...
# 676 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_IntClr(ADC_INT_Type intType)
{
    uint32_t tmpVal;
...
# 805 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Sts_Type ADC_GetIntStatus(ADC_INT_Type intType)
{
    uint32_t tmpVal;
...
# 853 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Int_Callback_Install(ADC_INT_Type intType,intCallback_Type* cbFun)
{
...
# 916 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Vbat_Enable(void)
{
    uint32_t tmpVal;
...
# 933 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Vbat_Disable(void)
{
    uint32_t tmpVal;
...
# 950 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_Tsen_Init(ADC_TSEN_MOD_Type tsenMod)
{
    uint32_t tmpVal;
...
# 1015 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
...
# 1073 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Err_Type __attribute__((section(".sclock_rlt_code.""/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" "1073"))) ADC_Trim_TSEN(uint16_t * tsen_offset)
{
...
# 1150 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_SET_TSVBE_LOW(void)
{
    uint32_t tmpVal;
    tmpVal=(*((volatile uint32_t*)(((uint32_t)0x4000F000)+(0x914))));
...
# 1166 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_SET_TSVBE_HIGH(void)
{
    uint32_t tmpVal;
    tmpVal=(*((volatile uint32_t*)(((uint32_t)0x4000F000)+(0x914))));
...
# 1182 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
float TSEN_Get_Temp(uint32_t tsen_offset)
{
    uint32_t v0 = 0, v1 = 0;
    float temp = 0;
...
# 1248 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Err_Type ADC_Mic_Init(ADC_MIC_Type * adc_mic_config)
{
    uint32_t tmpVal1=0,tmpVal2=0;
...
# 1295 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_MIC_Bias_Enable(void)
{
    uint32_t tmpVal;
...
# 1313 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
void ADC_MIC_Bias_Disable(void)
{
    uint32_t tmpVal;
...
# 1331 "/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c"
BL_Err_Type __attribute__((section(".sclock_rlt_code.""/home/dinhquangha/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_adc.c" "1331"))) ADC_Gain_Trim(void)
{
