# 1 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c"
# 1 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/build_out/lib_button//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c"
# 1 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.h" 1
...
# 5 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.h" 2
# 1 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/hardware/common/hardware.h" 1
# 6 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.h" 2
# 32 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.h"
...
# 2 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c" 2
...
# 4 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c" 2

# 1 "/home/dinhquangha/intern/Ai-Thinker-WB2/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/10.2.0/include/stddef.h" 1 3 4
# 6 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c" 2
...
# 7 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c" 2
...
# 8 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c" 2

extern uint8_t g_btn_filter_cnt;

static uint8_t m_btn_data[(4)] = {0};
...
static uint32_t m_btn_hold_timestamp[(4)] = {0};
static uint32_t m_btn_on_hold_count[(4)] = {0};
static uint32_t m_btn_last_press_time[(4)] = {0};
static uint8_t m_btn_press_cnt[(4)] = {0};
static uint32_t m_btn_instances[(4)];
...
uint32_t app_btn_on_hold_time_fire_event_ms = (5000);
...
void app_btn_initialize(app_btn_config_t *conf)
{
    ...
    if (
# 32 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c" 3 4
       ((void *)0) 
# 32 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c"
            == conf)
    {
...
void app_btn_scan(void *params)
{
    ...
    if ((4) < m_btn_config.btn_count)
    {

        return;
    }
    if (g_btn_filter_cnt < 1)
    {
        g_btn_filter_cnt = 1;
    }
    ...
    for (i = 0; i < m_btn_config.btn_count; i++)
    {
        ...
        if (m_btn_data[i] != m_hw_params[i].idle_level)
        {
            if (now - m_btn_hold_timestamp[i] >= app_btn_on_hold_time_fire_event_ms)
            {
                ...
                {
                    if (now - m_btn_on_hold_count[i] >= (5000))
                    {
        ...
        if ((m_btn_press_evt >> i) & 0x01)
        {
            ...
            if (now - m_btn_last_press_time[i] >= (1000))
            {
                m_btn_press_cnt[i] = 0;
            }
            else
            {
                ...
                {
                    if (
# 190 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c" 3 4
                       ((void *)0) 
# 190 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c"
                            != m_callback_table[evt])
                    {
            ...
            if (
# 199 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c" 3 4
               ((void *)0) 
# 199 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c"
        ...
        {
            if (
# 213 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c" 3 4
               ((void *)0) 
# 213 "/home/dinhquangha/intern/Ai-Thinker-WB2/datic/components/third_party/lib_button/app_btn.c"
