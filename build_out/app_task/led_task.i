# 1 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c"
# 1 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/build_out/app_task//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c"
# 1 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.h" 1
...
# 2 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c" 2
# 1 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_config/app_config.h" 1
# 3 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c" 2
...
# 4 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c" 2
...
# 5 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c" 2
...
# 6 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c" 2
...
# 7 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c" 2



# 9 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c"
static TaskHandle_t led_task_handle = 
# 9 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c" 3 4
                                     ((void *)0)
# 9 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c"
                                         ;
...
static led_blink_mode_t current_mode = LED_MODE_OFF;
...
static void led_task(void *pvParameters) {
    ...
    const TickType_t task_period = ( ( TickType_t ) ( ( ( TickType_t ) ( 50 ) * ( TickType_t ) ( ( TickType_t ) 1000 ) ) / ( TickType_t ) 1000 ) );
    ...
    while (1) {
        ...
        switch (current_mode) {
            ...
            case LED_MODE_SLOW:
                period = ( ( TickType_t ) ( ( ( TickType_t ) ( 1000 ) * ( TickType_t ) ( ( TickType_t ) 1000 ) ) / ( TickType_t ) 1000 ) );
                break;

            case LED_MODE_FAST:
                period = ( ( TickType_t ) ( ( ( TickType_t ) ( 200 ) * ( TickType_t ) ( ( TickType_t ) 1000 ) ) / ( TickType_t ) 1000 ) );
                break;

            case LED_MODE_ERROR:
                period = ( ( TickType_t ) ( ( ( TickType_t ) ( 100 ) * ( TickType_t ) ( ( TickType_t ) 1000 ) ) / ( TickType_t ) 1000 ) );
                break;
        }


        if (current_mode != LED_MODE_OFF && period > 0) {
            TickType_t elapsed = current_time - last_toggle_time;
            if (elapsed >= period) {
                led_handle_action(LED_EVENT_ON);
                vTaskDelay(( ( TickType_t ) ( ( ( TickType_t ) ( 10 ) * ( TickType_t ) ( ( TickType_t ) 1000 ) ) / ( TickType_t ) 1000 ) ));
...
void led_task_init(void) {
    ...
    printf("[LED_TASK] Initialized\r\n");
}

void led_task_run(void) {
    printf("[LED_TASK] Starting led_task...\r\n");
...
# 88 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c" 3 4
       ((void *)0)
# 88 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c"
           ,
        1,
        &led_task_handle
    );
    ...
    if (led_task_handle == 
# 93 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c" 3 4
                          ((void *)0)
# 93 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/app/app_task/led_task.c"
                              ) {
        printf("[LED_TASK] ERROR: Failed to create led_task!\r\n");
        return;
    }

    printf("[LED_TASK] led_task created successfully\r\n");
}

void led_set_blink_mode(int mode) {
    if (mode >= 0 && mode <= 3) {
        current_mode = (led_blink_mode_t)mode;
        ...
        printf("[LED_TASK] Blink mode set to %d\r\n", mode);
    }
}
