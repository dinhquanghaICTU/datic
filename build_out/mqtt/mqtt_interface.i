# 1 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
# 1 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/build_out/mqtt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
# 1 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.h" 1
...
# 5 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.h" 2

void mqtt_interface_init(void);
void mqtt_connect(void);

# 8 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.h" 3 4
_Bool 
# 8 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.h"
    mqtt_is_connected(void);
void mqtt_disconnect(void);
void mqtt_publish(const char *topic, const char *payload);
void mqtt_subscribe(const char *topic);
void mqtt_message_handler(const char *topic, const char *payload, int payload_len);
# 2 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 2
...
# 5 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/hardware/relay/relay.h" 2


# 6 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/hardware/relay/relay.h"
void relay_init(void);
void relay_on(void);
void relay_off(void);
void relay_toggle(void);
uint8_t relay_get_state(void);
# 3 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 2
...
# 4 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 2
...
# 5 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 2
...
# 6 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 2
...
# 7 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 2
...
# 8 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 2
...
# 9 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 2
# 17 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
static 
# 17 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 3 4
      _Bool 
# 17 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
           mqtt_connected = 
# 17 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 3 4
...
# 17 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
                                 ;
static char mqtt_broker[64] = "broker.hivemq.com";
static int mqtt_port = 1883;
static char mqtt_client_id[32] = "datic_device";
static char mqtt_topic_control[64] = "device/relay/control";
static char mqtt_topic_status[64] = "device/relay/status";


static void mqtt_relay_control_callback(const char *payload, int payload_len) {
    if (payload == 
# 26 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 3 4
                  ((void *)0) 
# 26 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
                       || payload_len <= 0) {
        return;
    }
    ...
    char cmd[16] = {0};
    int len = payload_len < 15 ? payload_len : 15;
    ...
    printf("[MQTT] Received relay command: %s\r\n", cmd);


    if (strcmp(cmd, "ON") == 0 || strcmp(cmd, "1") == 0 || strcmp(cmd, "TRUE") == 0) {
        printf("[MQTT] Turning relay ON\r\n");
        relay_on();

        mqtt_publish(mqtt_topic_status, "{\"state\":\"ON\"}");
    } else if (strcmp(cmd, "OFF") == 0 || strcmp(cmd, "0") == 0 || strcmp(cmd, "FALSE") == 0) {
        printf("[MQTT] Turning relay OFF\r\n");
        relay_off();

        mqtt_publish(mqtt_topic_status, "{\"state\":\"OFF\"}");
    } else {
...
void mqtt_interface_init(void) {
    printf("[MQTT] Initializing MQTT interface...\r\n");
    mqtt_connected = 
# 63 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 3 4
                    0
# 63 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
                         ;


    char *broker = ef_get_env("mqtt_broker");
    char *port_str = ef_get_env("mqtt_port");
    char *client_id = ef_get_env("mqtt_client_id");
    char *topic_control = ef_get_env("mqtt_topic_control");
    char *topic_status = ef_get_env("mqtt_topic_status");

    if (broker && strlen(broker) > 0) {
        strncpy(mqtt_broker, broker, sizeof(mqtt_broker) - 1);
    }
    if (port_str) {
        mqtt_port = atoi(port_str);
        if (mqtt_port <= 0) mqtt_port = 1883;
    }
    if (client_id && strlen(client_id) > 0) {
        strncpy(mqtt_client_id, client_id, sizeof(mqtt_client_id) - 1);
    }
    if (topic_control && strlen(topic_control) > 0) {
        strncpy(mqtt_topic_control, topic_control, sizeof(mqtt_topic_control) - 1);
    }
    if (topic_status && strlen(topic_status) > 0) {
        strncpy(mqtt_topic_status, topic_status, sizeof(mqtt_topic_status) - 1);
    }

    printf("[MQTT] Config: broker=%s, port=%d, client_id=%s\r\n",
           mqtt_broker, mqtt_port, mqtt_client_id);
    printf("[MQTT] Topics: control=%s, status=%s\r\n",
           mqtt_topic_control, mqtt_topic_status);
    printf("[MQTT] MQTT interface initialized\r\n");
}

void mqtt_connect(void) {
    printf("[MQTT] Connecting to MQTT broker %s:%d...\r\n", mqtt_broker, mqtt_port);
# 109 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
    vTaskDelay(( ( TickType_t ) ( ( ( TickType_t ) ( 1000 ) * ( TickType_t ) ( ( TickType_t ) 1000 ) ) / ( TickType_t ) 1000 ) ));
    mqtt_connected = 
# 110 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 3 4
                    1
# 110 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
                        ;
    printf("[MQTT] Connected to broker (simulated)\r\n");


    mqtt_subscribe(mqtt_topic_control);
...
# 125 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 3 4
_Bool 
# 125 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
    mqtt_is_connected(void) {
...
void mqtt_disconnect(void) {
    ...
    mqtt_connected = 
# 133 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c" 3 4
                    0
# 133 "/home/quanghaictu/intern/Ai-Thinker-WB2/datic/components/middle/mqtt/mqtt_interface.c"
                         ;
}
...
void mqtt_subscribe(const char *topic) {
    if (!mqtt_is_connected()) {
        printf("[MQTT] Not connected, cannot subscribe\r\n");
        return;
    }
...
void mqtt_message_handler(const char *topic, const char *payload, int payload_len) {
    ...
    if (strcmp(topic, mqtt_topic_control) == 0) {
        mqtt_relay_control_callback(payload, payload_len);
    }
}
