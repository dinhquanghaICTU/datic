...
user_clz:
.LFB11:
	.file 1 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_sys.c"
	.loc 1 23 1
	.cfi_startproc
.LVL0:
	.loc 1 24 5
...
.LVL5:
	...
	lui	s1,%hi(__global_pointer_head$)
	addi	a0,s1,%lo(__global_pointer_head$)
	li	a2,1176
	li	a1,0
	call	memset
.LVL6:
	...
	srli	a4,a5,8
	sb	a4,%lo(__global_pointer_head$+1)(s1)
	srli	a4,a5,16
	sb	a4,%lo(__global_pointer_head$+2)(s1)
	.loc 1 42 26
	lui	a4,%hi(__global_pointer_head$+96)
	.loc 1 40 26
	sb	a5,%lo(__global_pointer_head$)(s1)
	.loc 1 42 26
	addi	a4,a4,%lo(__global_pointer_head$+96)
	.loc 1 40 26
	srli	a5,a5,24
	sb	a5,%lo(__global_pointer_head$+3)(s1)
	.loc 1 42 5 is_stmt 1
	.loc 1 42 26 is_stmt 0
	srli	a3,a4,8
	addi	a5,s1,%lo(__global_pointer_head$)
	sb	a4,4(a5)
	sb	a3,5(a5)
	srli	a3,a4,16
	srli	a4,a4,24
...
.Letext0:
	...
	.file 4 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h"
	.file 5 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_sys.h"
	.file 6 "/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_aon.h"
...
.LASF231:
	.string	"/home/dinhquangha/intern/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_sys.c"
.LASF203:
